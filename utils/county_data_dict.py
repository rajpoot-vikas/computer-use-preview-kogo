...
new_data_o13 = {
    ...
    7: {
        ...
        "status": "WEBSITE BLOCKED: link is not opening. "
    },
    8: {
        "website": "https://egov.basgov.com/TownofPoughkeepsie/",
        # "website": "http://www.townofpoughkeepsie.com/",
        "parcel": "6162-20-920211-0000",
        "parcel2": "134689-6161-08-908870-0000",
        "parcel3":"6162-20-920211-0000",
        "status": "WORKING : NEED TO GIVE THE DIRECT WEBSITE TO THE COUNTY, insert the correct map number"
    },
    9: {
        "website" : "https://egov.basgov.com/hydepark/",
        # "website": "https://www.hydeparkny.us/168/Receiver-of-Taxes",
        "parcel": "6163-06-440867-0000",
        # "parcel1": "133200-6165-01-454644-0000",
        "status": "WORKING : NEED TO GIVE THE DIRECT WEBSITE TO THE COUNTY, insert the correct map number"
    },
    10: {
